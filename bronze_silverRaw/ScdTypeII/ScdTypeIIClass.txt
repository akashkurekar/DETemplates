...
class SCDTypeII: 
  ...
  def _add_helper_columns_to_update(self):
    ...
    """    
    data_columns = self.content_key_columns + ['__current', '__deleted', '__activation_datetime', '__deactivation_datetime', '__minimum_activation_date', '__business_key_hash', '__content_key_hash', '__is_historical', '__process_datetime']
